...
sed -i 's/gcc g++ make default-jdk-headless default-jre-headless pypy3/gcc g++ make default-jdk-headless default-jre-headless pypy3 fpc/g' /opt/domjudge/judgehost/bin/dj_make_chroot
sudo /opt/domjudge/judgehost/bin/dj_make_chroot -y -a amd64
